...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <main className="relative flex flex-col md:flex-row items-center justify-between bg-[url('/hero-bg.jpg')] bg-cover bg-center text-white min-h-screen">
...
<section className="max-w-6xl mx-auto mt-10 border-2 border-orange-400 rounded-lg p-8 bg-white">
  {/* Heading */}
  ...
  <div className="flex justify-center mb-8">
    <div className="flex space-x-2 bg-gray-200 rounded-md px-2 py-1">
      <span className="bg-gray-600 text-white px-4 py-1 rounded-md text-sm font-semibold">
        Professional
      </span>
      <span className="bg-gray-600 text-white px-4 py-1 rounded-md text-sm font-semibold">
        Affordable
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    ...
    <div>
      ...
      <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        equipments. From washers and dryers to spin machines and ironers. Our
        goal is to keep your laundry running smoothly with fast, reliable and
        professional service across Zimbabwe.
      </p>
      ...
      {/* Button */}
      <Link href="/about"><button className="bg-orange-500 text-white font-semibold px-6 py-2 rounded-lg hover:bg-orange-600 transition">
        Learn More
      </button></Link>
    </div>
...
<section className="max-w-6xl mx-auto mt-12 bg-white rounded-lg shadow-sm p-8">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    {/* Card 1 */}
    <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50 hover:shadow-md transition">
      <Image
        src="/dryer.png"
        width={400}
        height={200}
      ...
      <div className="bg-white p-4 border-t-4 border-orange-400">
        <h3 className="text-orange-500 font-bold text-md mb-2">
          Dryer Repair
        </h3>
    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50 hover:shadow-md transition">
      ...
      <div className="bg-white p-4 border-t-4 border-orange-400">
        ...
        <p className="text-gray-700 text-sm">
          We fix temperature issues, steam problems, leaks and power faults.
        </p>
      </div>
    </div>
