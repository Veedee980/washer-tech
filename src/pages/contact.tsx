...
export default function Contact() {
  ...
  return (
    <>
      ...
      {/* CONTACT SECTION */}
      <section className="bg-white px-6 md:px-20 py-20 font-outfit overflow-hidden">
        <motion.div
        ...
        >
          ...
          <div className="md:w-1/2 space-y-6 text-gray-700">
            ...
            <p>
              At Washer Tech, we specialize in repairing and maintaining all laundry
              equipment. Our goal is to keep your laundry running smoothly with fast,
              reliable, and professional service across Zimbabwe.
            </p>
          ...
          {/* Right: Form */}
          <motion.div
            className="md:w-1/2 bg-linear-to-b from-white to-orange-50 p-8 rounded-2xl shadow-lg border border-orange-100 hover:shadow-orange-200 transition-all duration-300"
            whileHover={{ scale: 1.02 }}
          >
            <form
              onSubmit={handleSubmit}
              className="space-y-6 bg-white p-8 rounded-2xl shadow-lg border border-gray-100 w-full max-w-lg mx-auto"
            >
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full p-3 placeholder-gray-500 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all duration-300"
                  required
                />
                ...
                <input
                  ...
                  className="w-full p-3 border placeholder-gray-400 border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all duration-300"
                  required
                />
                ...
                <textarea
                  ...
                  className="w-full p-3 border placeholder-gray-400 border-gray-300 rounded-lg h-32 focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all duration-300 resize-none"
                  required
                />
              </div>
              <button
                type="submit"
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-lg shadow-md transition-all duration-300 transform hover:scale-105"
              >
                Send Message
              </button>
